        ...
        >
            ...
            >
                ...
                <div className="flex items-center mb-8" data-oid="9g-4fr4">
                    <div className="text-blue-700 font-bold text-2xl" data-oid="jrw4bge">
                        Prody
                    </div>
                </div>
                ...
                <nav className="flex-1" data-oid="1r2j2hk">
                    <ul className="space-y-2" data-oid="283jzho">
                        <li data-oid="8m-4k3t">
                            <a
                                href="#"
                        ...
                        <li data-oid="6be9_zd">
                            ...
                            >
                                ...
                                <span className="hidden md:inline" data-oid="pzcdy52">
                                    Điểm danh
                                </span>
                                <span
                        ...
                        <li data-oid="8wr:t6i">
                            ...
                            >
                                ...
                                <span className="hidden md:inline" data-oid="0rmkch0">
                                    Finances
                                </span>
                            </a>
                        </li>
                ...
                <div
                    ...
                    data-oid="0om0sl2"
                >
                    <div className="flex items-center mb-3" data-oid="tip.vjq">
                        <div
                    ...
                    <div className="mb-3" data-oid="cp66j:v">
                        <div className="text-xs text-gray-500 mb-1" data-oid="eathkb8">
                            5/10 projects used
                        </div>
                        <div className="h-2 bg-gray-200 rounded-full" data-oid="41_pfxh">
                            <div
            ...
            >
                ...
                <div
                    ...
                    data-oid="9.n39ss"
                >
                    <div className="flex items-center text-sm" data-oid=".bnzvb7">
                        <a
                            href="#"
                        ...
                        <span className="text-gray-900 font-medium" data-oid="kqobz8b">
                            House Spectrum Ltd
                        </span>
                    </div>

                    <div className="flex space-x-3" data-oid="5l.a2bu">
                        <button
                        ...
                        <table className="w-full border-collapse" data-oid="z5.ae56">
                            ...
                            <tbody data-oid="9no27ye">
                                ...
                                <tr
                                    ...
                                    key="olk-49Po"
                                >
                                    <td className="py-4 px-6" data-oid="ljmz59c">
                                    ...
                                    <td className="py-4 px-6" data-oid="phmwzl9"></td>
                                    <td className="py-4 px-6 font-medium" data-oid="ui2yyf3">
                                        $1.8M
                                    </td>
                                    <td className="py-4 px-6 text-gray-500" data-oid="ua6k.1n">
                                        28 May 2023
                                    </td>
                                    <td className="py-4 px-6" data-oid="ao22s-:">
                                        <span
                                    ...
                                    <td className="py-4 px-6 text-right" data-oid="yetmmwk">
                                        <button
                                            className="text-gray-500 hover:text-blue-700"
                                            data-oid="6:p4rxo"
                                        >
                                ...
                                <tr
                                    ...
                                    key="olk-7_ON"
                                >
                                    <td className="py-4 px-6" data-oid="bc_nbpl">
                                    ...
                                    <td className="py-4 px-6" data-oid="bjffxnf"></td>
                                    <td className="py-4 px-6 font-medium" data-oid="j0lyv12">
                                        $3.2M
                                    </td>
                                    <td className="py-4 px-6 text-gray-500" data-oid="v6hpekl">
                                        03 Apr 2023
                                    </td>
                                    <td className="py-4 px-6" data-oid="a1jd-:n">
                                        <span
                                            className="bg-green-50 text-green-700 rounded-full px-3 py-1 text-sm"
                                            data-oid="3ao5d30"
                                        >
                                    ...
                                    <td className="py-4 px-6 text-right" data-oid="wexuwwc">
                                        <button
                                            className="text-gray-500 hover:text-blue-700"
                                            data-oid="o2xt7d8"
                                        >
