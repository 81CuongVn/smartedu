                    ...
                    <ul className="space-y-2" data-oid="283jzho" key="olk-3rH6">
                        ...
                        <li data-oid="8wr:t6i">
                            ...
                            >
                                ...
                                <span className="hidden md:inline" data-oid="i1vvahh">
                                    Hồ sơ học sinh
                                </span>
                            </a>
                        </li>
                        ...
                        <li data-oid="ufav:rc">
                            ...
                            >
                                ...
                                <span className="hidden md:inline" data-oid="l7uof:n">
                                    Điểm danh
                                </span>
                                <span
                                    className="hidden md:inline ml-auto bg-gray-200 rounded-full px-2 py-0.5 text-xs"
                        ...
                        <li data-oid="x1-m60-">
                            ...
                            >
                                ...
                                <span className="hidden md:inline" data-oid="iup2ih3">
                                    Điểm danh
                                </span>
                                <span
                                    className="hidden md:inline ml-auto bg-gray-200 rounded-full px-2 py-0.5 text-xs"
                        ...
                        <li data-oid="angmrzm">
                            ...
                            >
                                ...
                                <span className="hidden md:inline" data-oid="web7b8:">
                                    Điểm danh
                                </span>
                                <span
                                    className="hidden md:inline ml-auto bg-gray-200 rounded-full px-2 py-0.5 text-xs"
                        ...
                        <li data-oid="s2hi2g3">
                            ...
                            >
                                ...
                                <span className="hidden md:inline" data-oid=".ed2:xv">
                                    Điểm danh
                                </span>
                                <span
                                    className="hidden md:inline ml-auto bg-gray-200 rounded-full px-2 py-0.5 text-xs"
                        ...
                        <li data-oid="y:el43b">
                            ...
                            >
                                ...
                                <span className="hidden md:inline" data-oid="ekjq3.k">
                                    Điểm danh
                                </span>
                                <span
                                    className="hidden md:inline ml-auto bg-gray-200 rounded-full px-2 py-0.5 text-xs"
