...
export default function DashboardPage() {
    ...
    return (
        <ProtectedRoute allowedRoles={['USER']} data-oid="_rj4j65">
            <div
            ...
            >
                ...
                <aside
                    className={`bg-white shadow-sm min-h-screen ${isSidebarExpanded ? 'w-64' : 'w-16'} p-4 flex flex-col transition-all duration-300`}
                    data-oid="v0wzekv"
                >
                    {/* Logo and Toggle */}
                    <div className="flex items-center justify-between mb-8" data-oid="ly9ky5n">
                        <div
                            className={`text-blue-700 font-bold text-2xl ${!isSidebarExpanded && 'hidden'}`}
                            data-oid="m55ubf-"
                        >
                            smartEdu
                        </div>
                        <button
                            ...
                            className="p-2 rounded-md bg-gray-100 hover:bg-gray-200 text-gray-700 transition-all duration-200"
                            data-oid="ia4cv58"
                        >
                            {isSidebarExpanded ? (
                                <svg
                                ...
                                >
                                    ...
                                    <path
                                        fillRule="evenodd"
                                        d="M8.707 4.293a1 1 0 010 1.414L4.414 10l4.293 4.293a1 1 0 11-1.414 1.414l-5-5a1 1 0 010-1.414l5-5a1 1 0 011.414 0z"
                                        clipRule="evenodd"
                                        data-oid="e02g:n."
                                    />
                                </svg>
                                ...
                                >
                                    ...
                                    <path
                                        fillRule="evenodd"
                                        d="M11.293 15.707a1 1 0 010-1.414L15.586 10l-4.293-4.293a1 1 0 111.414-1.414l5 5a1 1 0 010 1.414l-5 5a1 1 0 01-1.414 0z"
                                        clipRule="evenodd"
                                        data-oid="s-oejnf"
                                    />
                                </svg>
                    ...
                    {/* Navigation Menu */}
                    <nav className="flex-1" data-oid="m65x2_l">
                        <ul className="space-y-2" data-oid="283jzho" key="olk-3rH6">
                            <li data-oid="8m-4k3t">
                                ...
                                >
                                    ...
                                    <span
                                        className={isSidebarExpanded ? 'inline' : 'hidden'}
                                        data-oid="riz8o2a"
                                    >
                                        Dashboard
                                    </span>
                            ...
                            <li data-oid="6be9_zd">
                                ...
                                >
                                    ...
                                    <span
                                        className={`${isSidebarExpanded ? 'inline' : 'hidden'} ml-auto bg-gray-200 rounded-full px-2 py-0.5 text-xs`}
                                        data-oid="j-y2e9e"
                                    >
                                        12
                                    </span>
                    ...
                    {isSidebarExpanded && (
                        <div className="flex items-center mb-6 relative" data-oid="4r5554_">
                            <input
                                type="text"
                                placeholder="Search..."
                    ...
                    {/* User profile */}
                    {isSidebarExpanded && (
                        <div className="mt-auto pt-4 border-t border-gray-100" data-oid="0om0sl2">
                    ...
                    >
                            ...
                            <div data-oid="zwnr35n">
                                ...
                                >
                                    <div className="flex items-center mr-4" data-oid="p-:t.p_">
                                        ...
                                        <span data-oid="wu8nror">{user?.first_name}</span>
                                    </div>
                        ...
                        <div className="flex flex-wrap gap-2" data-oid="iown_g1">
                            ...
                            >
                                ...
                                <span data-oid="i0pthv8">9.0/10</span>
                            </div>
                        </div>
                    </div>
