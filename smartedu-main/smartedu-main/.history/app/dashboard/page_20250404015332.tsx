...
export default function DashboardPage() {
    ...
    return (
        <ProtectedRoute allowedRoles={['USER']} data-oid="b.hzdb0">
            <div
            ...
            >
                ...
                >
                    {/* Logo and Toggle */}
                    <div className="flex items-center justify-between mb-8" data-oid="z836u-l">
                        <div
                    ...
                    {/* Navigation Menu */}
                    <nav className="flex-1" data-oid="tz95rtq">
